...
REM
REM Generated by Vivado on Thu Jul 03 12:23:17 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj all_mod_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj all_mod_tb_vlog.prj -log xvlog.log
